...
const FoodItem = ({name, description, id, imageUrl, price}) => {
  ...
  return (
    <div className="col-12 col-ms-6 col-md-4 col-lg-3 mb-4 d-flex justify-content-center">
             <div className="card" style={{"maxWidth" : "320px"}}>
   <Link to={`/food/${id}`}> <img src={imageUrl} className="card-img-top" alt="Product Image " height={200} width={60}/> </Link>
    <div className="card-body">
        <h5 className="card-title">{name}</h5>
        <p className="card-text">{description}</p>
        <div className="d-flex justify-content-between align-items-center">
            <span className="h5 mb-0">&#75;&#83;&#104; {price}</span>
            <div>
